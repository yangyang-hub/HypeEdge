...
def load_settings(environment: str | None = None) -> AppSettings:
    ...
    settings = AppSettings(
        ...
        external_reference=yaml_config.get("external_reference", {}),
        clickhouse=yaml_config.get("clickhouse", {}),
        postgres=yaml_config.get("postgres", {}),
        risk=yaml_config.get("risk", {}),
        action_budget=yaml_config.get("action_budget", {}),
        market_making=yaml_config.get("market_making", {}),
        funding_arb=yaml_config.get("funding_arb", {}),
